...
タスクトレイの **設定** から設定画面を開きます。新しい付箋の既定値（色・フォント・フォントサイズ・アイコン・タイトルバーの有無）、表示（ダークモード、言語）、動作（スタートアップ登録、折りたたみ中の本文プレビュー、折りたたみ・展開のアニメーション、折りたたみ・展開ボタン、ダブルクリックでの表示切替）、データ（保存フォルダ、エクスポート、インポート）をまとめています。変更はその場で反映して保存します。
