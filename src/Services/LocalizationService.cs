...
public static class LocalizationService
{
    ...
    public static string T(string key)
    {
        ...
        return key switch
        {
            ...
            "MarkdownFormatting" => english ? "Markdown formatting" : "Markdown書式",
            "FormatBold" => english ? "Bold" : "太字",
            "FormatStrike" => english ? "Strikethrough" : "取り消し線",
            "FormatCode" => english ? "Inline code" : "インラインコード",
            "FormatHeading1" => english ? "Heading 1" : "見出し1",
            "FormatHeading2" => english ? "Heading 2" : "見出し2",
            "FormatHeading3" => english ? "Heading 3" : "見出し3",
            "FormatBullets" => english ? "Bulleted list" : "箇条書き",
            "FormatTasks" => english ? "Checklist" : "チェックリスト",
            "FormatLink" => english ? "Insert / edit link..." : "リンクを挿入・編集...",
            "Yes" => english ? "Yes" : "はい",
