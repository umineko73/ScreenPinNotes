...
- Collapsed view
- Hidden title bar mode (the buttons appear on hover at the top right; collapsing leaves the first body line; a move handle appears when the note has no icon)
...
While a note is being edited it is labelled Editing in its bottom left corner, so it stays recognisable after the toolbar hides on losing focus.
